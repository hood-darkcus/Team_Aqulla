...
* **Physics-Informed Prediction:** Using physics based regression model to predict time for failure and danger levels
* **Live Dashboard Streaming:** Utilizes a FastAPI WebSocket manager to broadcast parsed kinematics, Danger Level (0-100%), and TTF directly to the frontend.
